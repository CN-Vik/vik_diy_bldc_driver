...
/*
 * Unity 是 ESP-IDF 里常用的单元测试框架。
 * TEST_CASE、TEST_ASSERT_EQUAL、TEST_ASSERT_TRUE_MESSAGE 等宏都来自 unity。
 */
#include "unity.h"
...
static void as5600_test_zero_calibration(void)
{
    ...
    TEST_ASSERT_TRUE_MESSAGE(
        as5600_degrees_near_zero_or_wrap_360(degrees, AS5600_ZERO_CAL_TOL_DEG),
